...
@RestController
@RequestMapping("/api/portal-academico-kafka")
public class PortalAcademicoKafkaResource {
    private final Logger log = LoggerFactory.getLogger(PortalAcademicoKafkaResource.class);

    private final KafkaProperties kafkaProperties;
    private KafkaProducer<String, String> producer;
    private ExecutorService sseExecutorService = Executors.newCachedThreadPool();

    public PortalAcademicoKafkaResource(KafkaProperties kafkaProperties) {
