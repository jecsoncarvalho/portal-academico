package com.portal.academico.web.rest;
...
import com.portal.academico.config.KafkaProperties;
...
class PortalAcademicoKafkaResourceIT {
    ...
    void setup() {
        ...
        PortalAcademicoKafkaResource kafkaResource = new PortalAcademicoKafkaResource(kafkaProperties);
    ...
    void producesMessages() throws Exception {
        restMockMvc
            .perform(post("/api/portal-academico-kafka/publish/topic-produce?message=value-produce"))
    ...
    void consumesMessages() throws Exception {
        ...
        MvcResult mvcResult = restMockMvc
            .perform(get("/api/portal-academico-kafka/consume?topic=topic-consume"))
            .andExpect(status().isOk())
